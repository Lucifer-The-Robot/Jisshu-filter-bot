...
USERNAME = environ.get('USERNAME', "https://t.me/Nishant_0786") # ADMIN USERNAME
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002483859543')) # The movie you upload in it will be deleted from the bot.
...
BUTTON_MODE = is_enabled('BUTTON_MODE', True)
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://injured-fiorenze-nishant0-7-b23eef91.koyeb.app/")
